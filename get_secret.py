#!/usr/bin/env python
'''
Original Author is x89 via https://github.com/x89/Shreddit/
...
r = praw.Reddit('Acronym Explainer refresh token grabber by /u/AlexDGr8r')
...
try:
    ...
    url = r.get_authorize_url('uniqueKey', ['identity', 'read', 'vote', 'edit', 'submit', 'privatemessages'], True)
